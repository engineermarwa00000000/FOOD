...
public class ChefRegistration extends AppCompatActivity {
    ...
    String fname,lname,emailid,password,confpassword,mobile,house,Area,role="Chef",statee,cityy,Pincode;
                                                           ...
                                                           builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                               ...
                                                               public void onClick(DialogInterface dialogInterface, int i) {
                                                                  ...
                                                                  String phonenumber = Cpp.getSelectedCountryCodeWithPlus()+mobile;
                                                                   Intent b = new Intent(ChefRegistration.this,ChefFoodPanel_BottomNavigation.class);
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(emailid)) {
            ...
            if (emailid.matches(emailpattern)) {
                ...
                Email.setErrorEnabled(true);
                Email.setError("Enter a valid Emil Id");
            }
        }
        ...
        isValid = (isValidarea && isValidpassword && isValidconfpassword && isValidpincode && isValidemail && isValidmobilenum && isValidname && isValidhouseno && isValidlname) ? true : false;
        return isValid;
    }
