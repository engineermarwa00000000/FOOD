...
public class
ChooseOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chef = (Button) findViewById(R.id.activity_choose_one_btn_chef);
        DeliveryPerson = (Button) findViewById(R.id.activity_choose_one_btn_delivery);
       Customer = (Button) findViewById(R.id.activity_choose_one_btn_customer);
